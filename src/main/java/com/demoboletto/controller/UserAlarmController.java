...
public class UserAlarmController {
    ...
    public ResponseDto<?> updateUserAlarmIsRead(@UserId Long userId, @PathVariable Long alarmId) {
    ...
    public ResponseDto<?> recordUserAlarm(@UserId Long userId, @RequestBody RecordUserAlarmDto recordUserAlarmDto) {
